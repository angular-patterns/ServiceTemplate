...
var ApplicationService = /** @class */ (function (_super) {
    ...
    ApplicationService.prototype.applications = function (reviewbusinessId, skip, take, sort) {
        var _this = this;
        this.getApplications(reviewbusinessId, skip, take, sort)
            .subscribe(function (x) { return _super.prototype.next.call(_this, x); });
    };
    ApplicationService.prototype.getApplications = function (reviewBusinessId, skip, take, sort) {
        var _this = this;
        this.loading = true;
